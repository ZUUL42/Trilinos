...
set (Amesos2_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Anasazi_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Belos_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Domi_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Ifpack2_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Kokkos_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (KokkosKernels_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (MueLu_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (NOX_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Phalanx_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (ROL_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Sacado_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (SEACAS_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (ShyLU_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (STK_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Teko_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Tpetra_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (TpetraCore_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Xpetra_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
set (Zoltan2_ENABLE_TESTS OFF CACHE BOOL "Turn off tests for UVM build")
